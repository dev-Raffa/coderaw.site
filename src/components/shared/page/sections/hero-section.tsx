...
export function HeroSection() {
  return (
    <div className="section ">
      <div className="h-full flex flex-col gap-[22px] max-w-4xl mx-auto">
        <div className="max-w-sm sm:max-w-4xl text-center mx-auto">
          <h1 className="block font-medium font-title text-4xl sm:text-5xl md:text-6xl lg:text-[5.4rem]">
            Soluções que <br /> impulsionam negócios
          </h1>
        </div>

        <div className="max-w-sm sm:max-w-4xl text-center mx-auto">
          <p className="text-base text-muted-foreground  md:text-xl lg:text-[26px]">
